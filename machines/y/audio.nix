...
in {
  ...
  environment.etc."pipewire/pipewire.conf.d/50-proxy-input-2_0.conf".text = ''
    context.modules = [
      {
        name = libpipewire-module-combine-stream
        args = {
  ...
  environment.etc."pipewire/pipewire.conf.d/60-roc-receiver-2_0.conf".text = ''
    context.modules = [
      {
  ...
  environment.etc."pipewire/pipewire.conf.d/60-roc-sender-2_0.conf".text = ''
    context.modules = [
    ${concatMapStringsSep "\n" (client: ''
      {
